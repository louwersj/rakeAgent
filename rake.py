...
#
# NOTE: The original code (from https://github.com/aneesha/RAKE) has been extended by a_medelyan (zelandiya) with a set
# of heuristics to decide whether a phrase is an acceptable candidate as well as the ability to set frequency and phrase
# length parameters important when dealing with longer documents. This fork has been optimized by Johan Louwers to be
# python 3.0 compliant.

# VERSION       #DATE           #NAME           #COMPANY    #REASON
# V0.1          02-JUL-2015     Johan Louwers   Capgemini   Forked code and made it Python 3.0 compatible.
# Vx.x
